...
class lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frecuencia = frecuencia = 100000
        self.amplitud = amplitud = 10

        ##################################################
        # Blocks
        ##################################################
        self._frecuencia_range = Range(50000, 200000, 10000, 100000, 200)
        ...
        self._amplitud_range = Range(1, 20, 1, 10, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1e3, 10, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(5, self.samp_rate, 3000, 6000, window.WIN_HAMMING, 10))
